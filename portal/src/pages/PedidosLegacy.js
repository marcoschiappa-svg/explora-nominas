...
function PedidosLegacy({ usuario, onVolver }) {
      ...
      {vista === 'panel' && (
        <div>
          <div style={styles.panelHeader}>
            <h2 style={styles.titulo}>Pedidos anteriores</h2>
            {/* SOLO LECTURA. Los pedidos nuevos se cargan desde el módulo
                "Pedidos" del modelo nuevo. Acá quedan los que ya existían,
                hasta que terminen su ciclo.

                Se conserva "Suspender": es la única acción que puede hacer
                falta de verdad sobre un pedido viejo —darlo de baja porque ya
                no va— y sin ella habría que tocar Firestore a mano.

                Editar no: si un pedido viejo necesita cambios, se suspende y
                se crea uno nuevo en el modelo nuevo. */}
