...
function Coordinador({ usuario, onVolver }) {
  ...
  // Punto ÚNICO de verdad: resuelve los datos de contacto del transporte desde su ficha
  // en usuarios_portal (mail, CUIT y teléfonos). Cualquier asignación debe pasar por acá,
  // para que ningún camino de la UI pueda guardar un transporte sin su correo.
  ...
  async function asignarTransportista(p, despachoIdx) {
    ...
    // Fondo del arreglo: resolver SIEMPRE los datos desde la ficha del usuario, sin importar
    // por cuál selector se eligió, y frenar si el transporte no tiene ningún correo cargado.
